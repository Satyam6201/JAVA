...
class TimestampDecorator extends INotificationDecorator {
    ...
    public String getContent() {
        return "[2026-05-27 14:10:00] " + notification.getContent();
    }
}
...
public class NotificationSystem {
    public static void main(String[] args) {
        ...
        notificationEngine.addNotificationStrategy(new EmailStrategy("satyamkmishraa@gmail.com"));
        notificationEngine.addNotificationStrategy(new SMSStrategy("+91 6201902313"));
